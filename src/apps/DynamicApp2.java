...
import information.DynamicSecondSetResouces;
...
public class DynamicApp2 {
    ...
    static Scanner key = new Scanner(System.in);
        ...
        public static void main (String[] args){
            int option;
            DynamicSecondSetResouces dynamic=null;
            do {
                showMenu();
                option = readInt("", 0, 9);
                switch (option) {
         ...
         */
        public static DynamicSecondSetResouces readFromFile(){
            ReadData r = new ReadData();
            System.out.print("\n\tIntroduce the file's name: ");
            String file = key.next();
            DynamicSecondSetResouces info = (DynamicSecondSetResouces) r.read(file, 2);
            if (info != null) {
                System.out.println("\n\tAll gone fine");
         ...
         */
        public static void removeQueries(DynamicSecondSetResouces info){
         ...
         * @param info where to delete
         */
        public static void removeQueriesByDate(DynamicSecondSetResouces info){
            int year;
         ...
         * @param info to find
         */
        public static void listUsers(DynamicSecondSetResouces info){
            String resource = readNum("\nIntroduce the name of the resource: ");
         ...
         */
        public static void listUsersByDate(DynamicSecondSetResouces info){
            int year;
            char month, day, hour, minute, second;
            String resource = readNum("\nIntroduce the name of the resource: ");
            year = Integer.parseInt(readNum("\nIntroduce the year: "));
         ...
         * @param info information
         */
        public static void  mostResource(DynamicSecondSetResouces info){
         ...
         * @param info information
         */
        public static void listResources(DynamicSecondSetResouces info){
         ...
         * @param info
         */
        public static void writeToFile (DynamicSecondSetResouces info){
